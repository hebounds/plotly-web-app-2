  ...
  return(
    <div className="text-center">
      <header className="bg-gunmetal min-h-screen flex flex-col justify-center items-center text-xl text-white">
        ...
        <div className="py-8 px-8 max-w-5xl mx-auto my-8 bg-battle-grey1 rounded-xl shadow-lg space-y-2">
          <div className="py-3 px-3 max-x-5xl my-1 bg-white rounded-xl shadow-lg space-y-2">
